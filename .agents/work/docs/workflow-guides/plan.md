...
- [ ] **Task 1: Build the Markdown-backed docs thin slice**
...
- [ ] **Task 2: Complete the three concise workflow guides**
  ...
  - Acceptance:
    ...
    - Content reflects v0.5 semantics: small work stays conversational, artifacts and handoffs are optional, current-thread execution is the default, evidence distinguishes observed/inherited/unverified, and closeout preserves the final snapshot before removal.
...
- [ ] **Task 3: Refine the focused responsive experience**
...
- [ ] **Task 4: Review, verify, and prepare the portal**
...
- Derive the hub and previous/next navigation from guide metadata rather than duplicating route labels.
